...
const Privacy = () => {
    ...
    useEffect(() => {
        axios.get(`${MAIN_URL}/api/page/get/privacy`)
            .then(response => {
                setPage(response.data.privacy);
                setBodyContent(response.data.privacy?.content);
                setLoading(false);
            })
            .catch(error => {
    ...
    const submitPost = (e) => {
        ...
        axios.post(`${MAIN_URL}/api/page/privacy/update`, formData, {
            headers: {
        ...
        <>
            ...
            <div className="w-full mx-auto bg-white shadow-md rounded px-4 pt-4 pb-4 mb-4">
                <div className="flex justify-between border-b-2 pb-4 mb-2">
                    <h3 className='h4'>Edit privacy policy</h3>
                </div>
