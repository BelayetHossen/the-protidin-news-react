...
const RightSideBar1 = () => {
    ...
    // console.log(JSON.parse(adbannerData?.rightad1)?.link);
        ...
        <>
            <div className='flex flex-col gap-2 w-full md:w-3/12 lg:w-3/12'>
                ...
                <div className="flex flex-col my-3">
                    <div className="flex">
                        <button
                            className={`w-1/2 px-4 py-2 bg-gray-200 ${activeTab === 1 ? 'bg-red-600' : ''}`}
                            onClick={() => handleTabClick(1)}
                        >
                            সর্বশেষ
                        </button>
                        <button
                            className={`w-1/2 px-4 py-2 bg-gray-200 ${activeTab === 2 ? 'bg-red-600' : ''}`}
